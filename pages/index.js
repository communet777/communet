      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroRight}>
          ...
          <div className={styles.statsRow}>
            <div className={styles.stat}><div className={styles.statN}>88</div><div className={styles.statL}>{t('home_stat_communities')}</div></div>
            <div className={styles.stat}><div className={styles.statN}>23</div><div className={styles.statL}>{t('home_stat_countries')}</div></div>
            <div className={styles.stat}><div className={styles.statN}>340+</div><div className={styles.statL}>{t('home_stat_offers')}</div></div>
          </div>
        </div>
      </section>
              ...
              <Link href={`/kommunen/${k.id}`} key={k.id} className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.cardFooter}>
                    <span className={styles.cardMembers}>~{k.members}</span>
                    <span className={styles.cardOffers}>{k.angebote} {t('nav_offers').toLowerCase()}</span>
                  </div>
                </div>
              </Link>
            )
